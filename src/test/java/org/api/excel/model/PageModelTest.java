...
class PageModelTest {
    ...
    void build_then_notProperties_when_NullPointerException() {
        Assertions.assertThatThrownBy(BookModel.aNew().page(null).cellModels(Collections.emptyList())::create)
    ...
    void build_then_sheetAnnotationIsNull_when_NullPointerException() {
        Assertions.assertThatThrownBy(BookModel.aNew().book(null).cellModels(Collections.emptyList())::create)
                .isInstanceOf(NullPointerException.class)
                .hasMessage("the annotation cannot is null");
    ...
    void build_then_cellModelsIsNull_when_NullPointerException() {
        ...
        Assertions.assertThatThrownBy(BookModel.aNew().page(annotation).cellModels(null)::create)
                .isInstanceOf(NullPointerException.class)
     ...
     *
     * <ul>
     *   <li>{@link BookModel#aNew()#builder()}
     * </ul>
     */
    @Test
    void build_then_cellModelsIsEmpty_when_IllegalArgumentException() {
        ...
        Page annotation = classAnnotation.orElse(null);
        Assertions.assertThatThrownBy(BookModel.aNew().page(annotation).cellModels(Collections.emptyList())::create)
