...
public class Conditions extends Require {
    ...
    public static <T> void requireNotEmpty(Collection<T> collection) {
        Conditions.requireNotEmpty(collection, "the Collection cannot be empty");
    }
    /**
    ...
    public static void requireNotEmpty(Object[] objects) {
        Conditions.requireNotEmpty(objects, "the annotation cannot is null");
    }
    /**
     * Optional non null.
     *
